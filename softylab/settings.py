"""
Django settings for softylab project.
...
SECRET_KEY = 'django-insecure-be)h*kcakz7rzodf393tr&k(flmr*h0t!-%obyuetn9=%u50%r'
...
WSGI_APPLICATION = 'softylab.wsgi.application'
